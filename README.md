...
<br/> _*"tree_electre_tri_b" arguments*_<br/>
...
<br/>"metrics" arguments. Returns the inferred parameters.<br/> 
...
<br/>*"plot_decision_boundaries" arguments*<br/>
